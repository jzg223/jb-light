dynamic.delay('vue-components', () => {
        ...
        template: `<div class="model_project_log"><div class="mb10">日志路径<input type="text" name="model_log_path" id="model_log_path" :value="path" placeholder="日志路径" class="ml10 bt-input-text mr10" style="width:350px" />\
